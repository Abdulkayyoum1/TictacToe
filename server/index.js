///libreries
const http = require("http"), ///comunication protocol
count  express = require("express"), ///node framework
  app = express(),
  socketIo = require("socket.io");
const fs = require("fs");

const server = http.Server(app).listen(8080); /// creazione del server
